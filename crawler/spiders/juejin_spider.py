"""
Juejin (掘金) spider — crawls career/job-related articles via JSON API.
Covers: job hunting, interview experience, offer comparison, career planning.
"""
import logging
import requests
            ...
            try:
                ...
                for item in (data.get('data', []) or []):
                    ...
                    articles.append({
                        ...
                        'content_snippet': truncate(summary, 2000),
                        'category': 'job',
